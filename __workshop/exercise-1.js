...
function question5() {
  ...
  // 5.1. ['cat', 42, 'bird']
  console.log("5.1. Number of elements (2)", ['string', number, 'string']);
  ...
  console.log("5.5. Number of elements (2)", [ object {key: 'value = string',key: 'value = number'}, object {key: 'value = string', key: 'value=number'}]);
}
